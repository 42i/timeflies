...
The items in this work package hierarchy can be referred to in activity lines as dot separated work package path names. In above work package definition examples for such paths are \verb:mg.in.xml:, \verb:mg.proc.phase-1:.

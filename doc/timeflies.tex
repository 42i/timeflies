...
\item Good example. Space characters used exclusively:
...
\item Acceptable example. Tab characters used exclusively:
...
\item Bad example, rejected by \timeflies. In line 4 both spaces and a tab character are used:
...
\item Another bad example that \timeflies\ will reject. Line 2 and 3 are indented with spaces, line 4 and 5 use tabs:
